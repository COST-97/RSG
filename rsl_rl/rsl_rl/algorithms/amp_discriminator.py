...
class AMPDiscriminator(nn.Module):
    def __init__(
        ...
        # self.common_step_counter = 2
        self.step_counter = 0

        # self.task_reward_lerp = task_reward_lerp
        self.amp_reward_lerp = amp_reward_lerp

        # self.Normalizer_reward = utils.Normalizer_reward(input_dim=1)
    ...
    def predict_amp_reward(
        ...
        with torch.no_grad():
            ...
            # reward = self.Normalizer_reward.normalize_torch(d,device=self.device)
    ...
    def _lerp_reward(self, disc_r, task_r):
        # print(self.task_reward_lerp)
        r = self.amp_reward_lerp * disc_r + task_r
        return r
